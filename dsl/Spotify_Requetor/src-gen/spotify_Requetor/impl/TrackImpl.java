 ...
 * </p>
 * <ul>
 *   <li>{@link spotify_Requetor.impl.TrackImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TrackImpl extends TypeImpl implements Track {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Spotify_RequetorPackage.TRACK__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Spotify_RequetorPackage.TRACK__NAME:
			return getName();
		}
